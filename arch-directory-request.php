...
if(isset($_POST['submit'])){
	...
	$obj->arch_direc_request_from($_POST);
	...
	<div class="main-panel">
		<div class="container">
			<div class="page-inner">			
				<h4 class="page-title mt-3">Request Form</h4>
						...
						<div class="card-body">
							<form  method="POST" action="" enctype="multipart/form-data" >
								<div class="row">
									...
									<div class="col-md-3">
										<div class="form-group form-group-default">
											...
											<input type="text" class="form-control" name="web_link" placeholder="Website Link " value="">
										</div>
									</div>
									<div class="col-md-3">
										<div class="form-group form-group-default">
											<label>Facebook Link</label>
											<input type="text" class="form-control" name="fb_link" placeholder="Facebook Link" value="">
										</div>
									</div>
								    <div class="col-md-3">
										<div class="form-group form-group-default">
									...
									<div class="col-md-3">
								   	...
								   	<div class="col-md-3">
										<div class="form-group form-group-default">
											...
											<input type="text" class="form-control" name="desig" placeholder="Designation" value="" required="">							
										</div>
									</div>									
									<div class="col-md-3">
										<div class="form-group form-group-default">
								...
								<div class="text-right mt-3 mb-3">
									...
									<a href="index.php" class="btn btn-warning btn-rounded">Back</a>
								</div>
