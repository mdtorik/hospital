...
if(isset($_POST['submit'])){
 ...
 //    $path = SITE_ROOT.DS."uploads".DS."archProfileImage".DS; // Upload directory    
	...
	// var_dump($_POST);
	// exit();
	$obj->set_arch_request_from_admin($_POST);
	...
	<div class="main-panel">
		<div class="container">
			<div class="page-inner">			
				<h4 class="page-title"><span class="text-success">Arch</span> New Request</h4>
								...
								<div class="row">
									<div class="col-md-3">
										<div class="form-group form-group-default">
											...
											<input type="text" class="form-control" name="institute_name" placeholder="Organization Name" value="">
										</div>
									</div>
									<div class="col-md-3">
										<div class="form-group form-group-default">
											<label>Bangla Name</label>
											<input type="text" class="form-control" name="bname" placeholder="Bangla Name" value="">
										</div>
									</div>
									<div class="col-md-3">
										<div class="form-group form-group-default">
											<label>SLug Url</label>
											<input type="text" class="form-control" name="slug_url" placeholder="Contact Number" value="">
										</div>
									</div>
									<div class="col-md-3">
										<div class="form-group form-group-default">
											<label>Beds No</label>
											<input type="number" class="form-control" name="student_qty" placeholder="Beds No" value="">
										</div>
									</div>
									<div class="col-md-3">
										<div class="form-group form-group-default">
											<label>Contact Number</label>
											<input type="number" class="form-control" name="contact_number" placeholder="Contact Number" value="">
										</div>
									</div>										
									<div class="col-md-3">
										<div class="form-group form-group-default">
									...
									<div class="col-md-3">
										<div class="form-group form-group-default">
											...
											<input type="text" class="form-control" name="mlink" placeholder="Goole Map Link" >
										</div>
									</div>
									<div class="col-md-3">
										<div class="form-group form-group-default">
											<label>Approved Status</label>
											<select class="form-control js-example-basic-single" name="approved_status" id="status_id">
								...
								<div class="col-md-3 ">
									...
									<div class="col-md-12">
										<div class="form-group form-group-default">
						            	   ...
						            	   <textarea name="intro_text" id="summernote" class="form-control" placeholder="Introduction text" rows="3"></textarea>
										</div>
									</div>
					         	</div>
